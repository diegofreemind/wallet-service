    ...
    week_events: [
        {
            ...
            date: setTimezone("2019-09-01T17:30:00-03:00")
        },
        {
            customerId: faker.random.uuid(),
            status: "completed",
            customerName: faker.company.companyName(),
            date: setTimezone("2019-09-01T11:30:00-03:00")
        },
        {
            customerId: faker.random.uuid(),
            status: "rescheduled",
            customerName: faker.company.companyName(),
            date: setTimezone("2019-09-01T18:30:00-03:00")
        }, {
            customerId: faker.random.uuid(),
            status: "cancelled",
            customerName: faker.company.companyName(),
            date: setTimezone("2019-09-01T13:30:00-03:00")
        }
    ],
